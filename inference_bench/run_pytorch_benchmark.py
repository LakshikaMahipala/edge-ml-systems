...
def main() -> None:
    ...
    print("PyTorch Benchmark (Day 3)")
    print(f"Python: {sys.version.split()[0]}")
    print(f"Platform: {platform.platform()}")
    print(f"Torch: {torch.__version__}")
    print(f"Args: model={args.model}, device={args.device}, input_size={args.input_size}, warmup={args.warmup}, iters={args.iters}, topk={args.topk}")
    print("")
